...
const Form = () => {
                ...
                switch (e.type) {
                    ...
                    case 'category':
                        ...
                        if (incomeCategories.map((iC) => iC.type).includes(c)) {
                            setFormData((prev) => ({ ...prev, category: c, type: 'Income' }));
                        }
                        else if (expenseCategories.map((iC) => iC.type).includes(c)) {
                            setFormData((prev) => ({ ...prev, category: c, type: 'Expense' }));
                        }
                        break;
                    case 'date':
    ...
    }, [segment, createTransaction, formData.amount, formData.type, formData.date, formData.category]);
